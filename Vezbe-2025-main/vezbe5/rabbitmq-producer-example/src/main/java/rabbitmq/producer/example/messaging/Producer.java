...
public class Producer {
    ...
    public void sendTo(String routingkey, String message){
        log.info("Sending> ... Message=[ {} ] RoutingKey=[{}]", message, routingkey);
     ...
     * exchange ce rutirati poruke u pravi queue na osnovu binding-a (pogledati klasu MQConfiguration).
     */
    public void sendToExchange(String exchange, String routingkey, String message){
        log.info("Sending> ... Message=[ {} ] Exchange=[{}] RoutingKey=[{}]", message, exchange, routingkey);
